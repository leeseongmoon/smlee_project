...
public class MoonStringUtil {
     ...
     * @return
     */
    public  String lPadZero(String origin, int length){
     ...
     * @return
     */
    public String lPadSpace(String origin, int length){
     ...
     * @return
     */
    public String lPad(String origin, char letter, int length){
        if(origin == null){
            origin = "";
        }
     ...
     * @return
     */
    public  String rPadZero(String origin, int length){
     ...
     * @return
     */
    public String rPadSpace(String origin, int length){
     ...
     * @return
     */
    public String rPad(String origin, char letter, int length){
        if(origin == null){
            origin = "";
        }
    ...
    /**
     * 매개 변수 인코딩 : Map을 http parameter형식의 스트링으로 리턴한다.
     * @param data
     * @return
     */
